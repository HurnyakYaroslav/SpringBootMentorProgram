...
//    }
//
//    public Abiturient getByFirstName(String firstName) {
//        log.info("Getting Abiturient by firstname: {}", firstName);
//        return manager.createQuery("SELECT a FROM Abiturient a WHERE a.firstName = '" + firstName + "'", Abiturient.class)
//                .getSingleResult();
//    }
